...
​						Step1：使用0.8准确度的baseline+Focalloss将整张图预测出来，因此可以得出所有节点的标签（整体的准确度为0.8，是可信的)。![image-20211108192445645](https://github.com/daimaohui/ATEC-TASK2-Rank2/blob/master/image-20211108185713945.png)
